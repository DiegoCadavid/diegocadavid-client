...
const NavMenu = () => {
  ...
  return (
    <>
      <div className="container mx-auto hidden sm:flex  justify-end items-center">
      ...
      <div className="container px-5 relative flex flex-col sm:hidden items-end">
        <button className="w-10 h-10 bg-slate-50 rounded shadow active:bg-slate-300 dark:bg-slate-700 dark:active:bg-slate-800 transition-colors ease-linear" onClick={toggleShowDropdown}>
