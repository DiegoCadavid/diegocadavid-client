...
export const About = () => {
  return (
    <div id="about" className=" container mx-auto p-5  sm:p-0 min-h-screen flex flex-col gap-3 items-center justify-center">
      <div className="bg-slate-50  max-w-4xl dark:bg-slate-900 rounded overflow-hidden flex flex-col sm:flex-row items-center gap-1 py-8 sm:py-0 transition-colors ease-in">
        ...
        <div className="p-5">
          ...
          <p className="text-slate-600 dark:text-slate-300 mt-2">
            ...
            web ( Anteriormente el desarrollo de videojuegos ) en todas sus areas desde el <b> Frontend </b> hasta el
